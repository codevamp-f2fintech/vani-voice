...
const AgentTemplates: React.FC = () => {
  ...
  const templates = [
    {
      ...
      name: "HR Recruiter",
      icon: Users,
      desc: "Screening candidates for Marketing & Sales roles with a simulated natural Indian HR persona.",
      color: "bg-pink-600",
      tags: ["Recruitment", "HR"]
    },
    {
  ...
  const handleUseTemplate = (templateId: string) => {
    const config = AGENT_TEMPLATES[templateId];
    navigate('/agents/create', { state: { templateConfig: config } });
  };
